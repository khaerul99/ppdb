                            ...
                            >
                                ...
                                >
                                    <img
                                        ...
                                        src="../../../build/assets/img/carousel-1.jpg"
                                        alt="carousel image"
                                    />
                                    <div class="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
                                        ...
                                        <p class="dark:opacity-80">
                                            There’s nothing I really wanted to
                                            do in life that I wasn’t able to get
                                            good at.
                                        </p>
                                    </div>
                                </div>
                                ...
                                >
                                    <img
                                        class="object-cover h-full"
                                        src="../../../build/assets/img/carousel-2.jpg"
                                        alt="carousel image"
                                    />
                                    <div class="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
                                        <div class="inline-block w-8 h-8 mb-4 text-center text-black bg-white bg-center rounded-lg fill-current stroke-none">
                                ...
                                >
                                    <img
                                        class="object-cover h-full"
                                        src="../../../build/assets/img/carousel-3.jpg"
                                        alt="carousel image"
                                    />
                                    <div class="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
                                        <div class="inline-block w-8 h-8 mb-4 text-center text-black bg-white bg-center rounded-lg fill-current stroke-none">
                                        ...
                                        <p class="dark:opacity-80">
                                            Don’t be afraid to be wrong because
                                            ...
                                            <tr>
                                                <td class="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                                                    <div class="flex items-center px-2 py-1">
                                                        <div>
                                                            <img
                                                                src="../../../build/assets/img/icons/flags/US.png"
                                                                alt="Country flag"
                                                            />
                                                        </div>
                                                        <div class="ml-6">
                                            ...
                                            <tr>
                                                <td class="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                                                    <div class="flex items-center px-2 py-1">
                                                        <div>
                                                            <img
                                                                src="../../../build/assets/img/icons/flags/DE.png"
                                                                alt="Country flag"
                                                            />
                                                        </div>
                                                        <div class="ml-6">
                                            ...
                                            <tr>
                                                <td class="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                                                    <div class="flex items-center px-2 py-1">
                                                        <div>
                                                            <img
                                                                src="../../../build/assets/img/icons/flags/GB.png"
                                                                alt="Country flag"
                                                            />
                                                        </div>
                                                        <div class="ml-6">
                                            ...
                                            <tr>
                                                <td class="p-2 align-middle bg-transparent border-0 w-3/10 whitespace-nowrap">
                                                    <div class="flex items-center px-2 py-1">
                                                        <div>
                                                            <img
                                                                src="../../../build/assets/img/icons/flags/BR.png"
                                                                alt="Country flag"
                                                            />
                                                        </div>
                                                        <div class="ml-6">
